...
function Temp(props) {
  ...
  const getWeatherInfo = async () => {
    setLoading(true);
    try {
      let url = `https://api.openweathermap.org/data/2.5/weather?q=${searchValue}&units=metric&appid=2c4e3205805834d4c4c1cd9292ced582`;
    ...
    <div className="temp-wrap">
      <div className="weather-info-container">
...

        {
          ...
          errorMessage ? <ErrorMessage city={searchValue} /> : <WeatherDetailsCard weatherInfo={weatherInfo}  />) 
          : (
